...
function keyPressed()
{
  if (keyCode===32)
  {
    playerArrow = new PlayerArrow(playerArcher.body.position.x,playerArcher.body.position.y);
...
function keyReleased() {
  if (keyCode === 32) {
  playerArrow.shoot(playerArcher.body.position.x,playerArcher.body.position.y)
  }
}
...
function showArrows(arrow,index)
{
  ...
  {
    World.remove(world,playerArrow.body)
